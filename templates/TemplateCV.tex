...
\begin{cvtable}
    ...
    {Mgx.io SPRL is a company specialized in consulting, developing and training
     of applications written in Python.  } \end{cvtable}
    \cvitemx{Entso-e -- Brussels -- Belgium}{Python Expert -- 2019-Q3 -- Today}
    {ENTSO-E and all Transmission System Operators need to operate in a clear and safe legal and regulatory framework. } \end{cvtable}
